...
TCP_packet_type_create(TCP_PACKETS.T2_LOCAL_PLAYER_INFO,tcp_cb_T2_LocalPlayerInfo,buffer_u8,buffer_string)
TCP_packet_type_create(TCP_PACKETS.T2_PLAYER_INFO,tcp_cb_T2_PlayerInfo,buffer_u8,buffer_string)
...
TCP_packet_type_create(TCP_PACKETS.T2_EVENT_NOTIFICATION, tcp_cb_T2_EventNotification, buffer_u8)