...
if type == network_type_data
{
	...
	#region Gloomy's recieve data code
	...
	{
		show_error("A packet has been received with a packetId of " + string(_packetId) + ", but has not been registered in gnet_packet_layouts() \n Make sure you register this packet type! No data read", true);
		return;
	}
